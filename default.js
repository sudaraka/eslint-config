...
module.exports = {
  ...
  'rules': {
    ...
    // Best Practices
    'accessor-pairs': 1,
    'array-callback-return': 0,  // can't use bcs this doesn't verify object of the method is an Array
    'block-scoped-var': 2,
    'complexity': 2,
    'consistent-return': 0,
    'curly': 2,
    ...
    'no-undefined': 2,
    'no-unused-vars': 2,
    'no-use-before-define': [0, { 'classes': true, 'functions': true }],
    ...
    'no-new-object': 2,
    'no-plusplus': 2,
    'no-restricted-syntax': [2, 'WithStatement', 'SwitchStatement'],
    'no-spaced-func': 2,
    'no-ternary': 0,
